...
function Addproduct() {
    const handleSubmit = async (e) => {
        ...
        const mainImage = e.target[4].value;
        const additionalImage1 = e.target[5].value;
        const additionalImage2 = e.target[6].value;
        const additionalImage3 = e.target[7].value;
        const images = [mainImage, additionalImage1, additionalImage2, additionalImage3];

        const product = { title, description, price, category, images };
        try {
