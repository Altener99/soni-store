...
function ProductDetails() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Navbar/>
      <div className="max-w-6xl  mx-auto px-4 md:py-36">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button className="bg-gray-200 text-gray-800 px-8 py-2 rounded-full font-semibold hover:bg-gray-300 transition duration-200">
                Buy Now
              </button>
            </div>
          </div>
